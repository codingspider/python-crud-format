import datetime
from ..forms.bookissueform import AddBookIssueForm, EditBookIssueForm
...
class AddBookIssueView(View):
    model = BookIssue
    form_class = AddBookIssueForm
    template_name = 'bookissue/add_bookissue.html'
